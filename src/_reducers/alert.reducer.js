import { alertConstants, requestConstants, userConstants } from '../_constants';

const defaultLoadCircle = "data:image/gif;base64,";

export function alert(state = {}, action) {
  switch (action.type) {
    case requestConstants.NEW_RIDE_SUCCESS:
    ...
    case alertConstants.LOADING:
      return {
        load_circle: true,
        circle_type: action.circle_type
      };
    default:
      return state
  }
